...
function deleteImage(imgContainer, file) {
    imgContainer.remove();
    // Remove file from uploaded files list (if necessary)
    // You might need to implement logic to handle this based on your application's needs
}
